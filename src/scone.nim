...
type
  ...
  SconeSemanticPass* = enum
    scoSemPassDecls,          # find top level declarations
    ...
    scoSemPassHandleExprs,    # handle function overloads.
  ...
  SconeMacroPass* = enum
    ...
    #scoMacroPassMaybeRepeat, 
                              # If the AST returned by the macro contains
                              # other macro invocations, this process
                              # iterates.
    limScoMacroPass,
